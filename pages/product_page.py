...
class ProductPage(BasePage):
    ...
    #     assert self.is_not_element_present(*ProductPageLocators.MESSAGES_BLOCK), \
    #         "Success message is presented, but should not be"

    # def should_not_be_message_disappeared(self):
    #     assert self.is_disappeared(*ProductPageLocators.MESSAGES_BLOCK), \
    #         "Success message is presented, but should not be"